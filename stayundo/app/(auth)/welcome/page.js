  ...
  return (
    <>
      ...
      <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-[32px] bg-white shadow-xl">
        <div className="grid md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-10">
            ...
            <p className="mt-6 max-w-sm leading-7 text-slate-500">
              Welcome to StayUndo. Your gateway to Kerala's most premium and
              curated accommodations is now open. Start exploring backwater
              villas, misty plantation stays, and coastal escapes.
            </p>
      ...
      <div className="mt-10 text-center">
        <p className="text-sm text-slate-500">
          Need help getting started?{" "}
          <a href="#" className="font-medium text-violet-600 underline">
            Visit our help center
          </a>
        </p>
      </div>
